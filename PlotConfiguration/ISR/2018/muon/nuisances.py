...
nuisances['alphaS'] = {
    ...
    'samples'   : {
        ...
        #'WJets_MG'      : alphaS_syst , # check why this gives nan
...
#    'type'      : 'shape',
#    'samples'   : {
#        'DYJets@DYJetsToMuMu'  : pdfErr_syst ,
#        'DYJets10to50@DYJets10to50ToMuMu'    : pdfErr_syst ,
#        'DYJets@DYJetsToTauTau'        : pdfErr_syst ,
#        'DYJets10to50@DYJets10to50ToTauTau'  : pdfErr_syst ,
