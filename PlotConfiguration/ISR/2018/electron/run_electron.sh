...
#mkPlot.py --pycfg configuration_electron.py --inputFile=Output_Electron_control_SFapplied_ISR_detector_only_v1_ISR_detector_plots_electron/ISR_detector_plots_electron.root  --minLogC=1 --maxLogC=1000 --showIntegralLegend=0 --minLogCratio=2 --maxLogCratio=5000 
#mkPlot.py --pycfg configuration_electron.py --inputFile=Output_Electron_control_SFapplied_test_ISR_detector_only_v2_Eff_SF_v1_ISR_detector_plots_electron/electron_hist.root  --minLogC=1 --maxLogC=1000 --showIntegralLegend=0 --minLogCratio=2 --maxLogCratio=5000 
