...
variables['mll_variable_bin'] = {
    'name': 'dilep_mass_rec_Fake',
    'range': ([40,42.5,45,47.5,50,52.5,55,57.5,60,62.5,65,67.5,70,72.5,75,77.5,80,82.5,85,87.5,90,92.5,95,97.5,100,102.5,105,107.5,110,112.5,115,117.5,120,123,126,129.5,133,137,141,145.5,150,155,160,165.5,171,178,185,192.5,200,209,218,229,240,254,268,284,300,325,350],),
    'xaxis': 'm_{ll} [GeV]',
    'go1D':  True,
    'fold' : 0
    }
