...
nuisances['trig_sf'] = {
    ...
    'samples'	: {
       ...
       'SingleTop_tW_antitop_Incl'           : trg_syst ,
       'SingleTop_tW_top_Incl'           : trg_syst ,
       'WJets_MG'              : trg_syst ,
       'WW_pythia'             : trg_syst ,
       'WZ_pythia'             : trg_syst ,
       'ZZ_pythia'             : trg_syst ,
...
nuisances['id_sf'] = {
    ...
    'samples'   : {
       ...
       'TTLL_powheg'           : id_syst ,
       'SingleTop_tW_antitop_Incl'           : id_syst ,
       'SingleTop_tW_top_Incl'           : id_syst ,
       'WJets_MG'              : id_syst ,
       'WW_pythia'             : id_syst ,
       'WZ_pythia'             : id_syst ,
       'ZZ_pythia'             : id_syst ,
...
nuisances['iso_sf'] = {
    ...
    'samples'   : {
       ...
       'SingleTop_tW_antitop_Incl'           : iso_syst ,
       'SingleTop_tW_top_Incl'           : iso_syst ,
       'WJets_MG'              : iso_syst ,
       'WW_pythia'             : iso_syst ,
       'WZ_pythia'             : iso_syst ,
       'ZZ_pythia'             : iso_syst ,
...
nuisances['l1prefire'] = {
    ...
    'samples'   : {
       ...
       'SingleTop_tW_antitop_Incl'           : l1prefire_syst ,
       'SingleTop_tW_top_Incl'           : l1prefire_syst ,
...
nuisances['pileup'] = {
    ...
    'samples'   : {
       ...
       'SingleTop_tW_antitop_Incl'           : pileup_syst ,
       'SingleTop_tW_top_Incl'           : pileup_syst ,
...
nuisances['alphaS'] = {
    ...
    'samples'	: {
        ...
        'SingleTop_tW_antitop_Incl' : alphaS_syst ,
        'SingleTop_tW_top_Incl'     : alphaS_syst ,
...
nuisances['pdfScale'] = {
    ...
    'samples'	: {
       ...
       'SingleTop_tW_antitop_Incl'           : pdfScale_syst ,
       'SingleTop_tW_top_Incl'           : pdfScale_syst ,
