...
variables['mll TUnfold matrix'] = {
    ...
    'fold': 0, 
    'range': None, 
    'name': 'Get1DMassRecBinIndex(dilep_mass_rec):Get1DMassGenBinIndex(dilep_mass_gen_prefsr)', 
    'xaxis': 'Pre FSR',
    'useTUnfoldBin': True,
    'go1D': False,
    'isResMatrix':True
...
variables['ptll TUnfold matrix'] = {
    ...
    'fold': 0,
    'range': None,
    'name': 'Get2DPtRecBinIndex(dilep_pt_rec, dilep_mass_rec):Get2DPtGenBinIndex(dilep_pt_gen_prefsr, dilep_mass_gen_prefsr)',
    'xaxis': 'Pre FSR',
    'useTUnfoldBin': True,
    'go1D': False,
    'isResMatrix':True
