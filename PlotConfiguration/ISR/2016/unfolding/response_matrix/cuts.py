...
#cuts['fiducial_phase_pre_FSR_dRp1_even'] = 'Entry$%2==0 && evt_tag_dielectron_fiducial_lepton_matched_dressed_drX[0] == 1 && evt_tag_dielectron_rec == 1 && evt_tag_analysisevnt_sel_rec == 1 '
#cuts['fiducial_phase_pre_FSR_dRp1_odd'] = 'Entry$%2==1 && evt_tag_dielectron_fiducial_lepton_matched_dressed_drX[0] == 1 && evt_tag_dielectron_rec == 1 && evt_tag_analysisevnt_sel_rec == 1 '
