...
#mkShapes.py --pycfg  configuration_muon.py -n 100 --nTotFiles 0  --overWrite --doBatch --multiQueue 
...
mkShapes.py --pycfg  configuration_muon.py -n 300 --nTotFiles 0  --overWrite --doHadd --cleanUp
