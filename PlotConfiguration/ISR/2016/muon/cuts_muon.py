...
cuts['detector_level']           = 'evt_tag_dimuon_rec_Nominal == 1 && evt_tag_analysisevnt_sel_rec_Nominal == 1 && dilep_pt_rec_Nominal < 100. && dilep_mass_rec_Nominal > 40. && dilep_mass_rec_Nominal < 320.'
cuts['detector_level_m40to64']   = 'evt_tag_dimuon_rec_Nominal == 1 && evt_tag_analysisevnt_sel_rec_Nominal == 1 && dilep_pt_rec_Nominal < 100. && dilep_mass_rec_Nominal > 40. && dilep_mass_rec_Nominal < 64.'
cuts['detector_level_m64to81']   = 'evt_tag_dimuon_rec_Nominal == 1 && evt_tag_analysisevnt_sel_rec_Nominal == 1 && dilep_pt_rec_Nominal < 100. && dilep_mass_rec_Nominal > 64. && dilep_mass_rec_Nominal < 81.'
