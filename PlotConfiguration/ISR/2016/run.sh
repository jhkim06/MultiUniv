...
mkPlot.py --pycfg configuration.py --inputFile=Output_MetFt_L_v2_LL_v1_ISR_detector_only_v1_Eff_SF_v1_ISR/ISR.root  --minLogC=1 --maxLogC=1000 --showIntegralLegend=1
