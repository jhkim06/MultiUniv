...
mkPlot.py --pycfg configuration.py --inputFile=Output_MetFt_L_v2_LL_v1_ISR_detector_only_v1_Eff_SF_v1_ISR_detector_plots/ISR_detector_plots.root  --minLogC=1 --maxLogC=1000 --showIntegralLegend=0 --minLogCratio=2 --maxLogCratio=5000 
