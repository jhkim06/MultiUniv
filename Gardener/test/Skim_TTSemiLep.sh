...
'
for sample in SingleMuon SingleElectron TT_powheg DYJets10to50_MG DYJets WJets_MG WW_pythia WZ_pythia ZZ_pythia
do
  echo $sample
  ./mkGardener.py --Category TTSemiLep -a Skim_TTSemiLep -y 2016 -i $sample  -n 50 --nTotFiles 1  --userflags MetFt,L --skimV 9 --dry_run 
done
