...
do
  ...
  #mkGardener.py --Category SMP -a Skim_DiLep -y 2017 -i $sample -n 500 --nTotFiles 0 --InSkim MetFt_L_v0_LL_v0 --userflags MuMuOrElEl --skimV 99 --dry_run
