...
do
  #./mkGardener.py --Category SMP -a Skim_TTSemiLep -y 2017 -i $sample -n 1000 --nTotFiles 0  --userflags TTSemiLep --InSkim  MetFt_L_v1 --skimV 1
  ./mkGardener.py --Category SMP -a Skim_K2 -y 2017 -i $sample -n 300 --nTotFiles 0  --userflags K2 --InSkim MetFt_L_v1_TTSemiLep_v1 --skimV 1
done


# other MC
for sample in DYJets10to50_MG DYJets TTJJ_powheg TTLL_powheg WJets_MG WW_pythia WZ_pythia ZZ_pythia ttW ttZ SingleTop_sch_top SingleTop_tch_top SingleTop_tch_antitop SingleTop_tW_top SingleTop_tW_antitop
...
do
  echo $sample
  #./mkGardener.py --Category SMP -a Skim_TTSemiLep -y 2017 -i $sample -n 50 --nTotFiles 0  --userflags TTSemiLep --InSkim  MetFt_L_v1 --skimV 1
  ./mkGardener.py --Category SMP -a Skim_K2 -y 2017 -i $sample -n 50 --nTotFiles 0  --userflags K2 --InSkim MetFt_L_v1_TTSemiLep_v1 --skimV 1
done
