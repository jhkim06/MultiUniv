...
do
 ...
 #./mkGardener.py --Category SMP -a Skim_TTSemiLep -y 2017 -i $sample  -n 500 --nTotFiles 0  --userflags TTSemiLep --InSkim MetFt_L_v1 --skimV 3 --resubmit
 ./mkGardener.py --Category SMP -a Skim_K2 -y 2017 -i $sample  -n 500 --nTotFiles 0  --userflags K2 --InSkim MetFt_L_v1_TTSemiLep_v3 --skimV 1
done
