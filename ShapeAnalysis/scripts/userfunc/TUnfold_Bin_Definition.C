...
const int nmassbin_forPt_muon = 6;
const Double_t massbin_forPt_muon[nmassbin_forPt_muon+1] = {15, 40, 60, 81, 101, 200, 320};
...
void SetPtBinningRec(TString channel = "electron"){
 ...
 if( channel.CompareTo("muon") == 0 )     ptBinningRec->AddAxis("mass", nmassbin_forPt_muon, massbin_forPt_muon, true, true);
}
...
void SetPtBinningGen(TString channel = "electron"){
 ...
 if( channel.CompareTo("muon") == 0 )     ptBinningGen->AddAxis("mass", nmassbin_forPt_muon,massbin_forPt_muon, true, true);
}
